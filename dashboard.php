...
<!--MAIN DASHBOARD -->
    <body>
        <header>
        <div class="titleBlock" class="justify-content-center">
            <h1 class="display-1 text-success text-center">My G* </h1>
            <h2 class="display-4 text-success text-center">Plant Planner Buddy</h2>
        </div>
...
<div class="container-fluid">
            ...
            <div class="container-fluid">
            <h1 class="display-3">Completed/Upcoming</h1>
